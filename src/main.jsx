...
const regionOptions = [
  ...
  { code: '11740', label: '서울 강동구', query: '서울 강동구' },
  { code: '11305', label: '서울 강북구', query: '서울 강북구' },
  { code: '11500', label: '서울 강서구', query: '서울 강서구' },
  { code: '11620', label: '서울 관악구', query: '서울 관악구' },
  { code: '11215', label: '서울 광진구', query: '서울 광진구' },
  { code: '11530', label: '서울 구로구', query: '서울 구로구' },
  { code: '11545', label: '서울 금천구', query: '서울 금천구' },
  { code: '11350', label: '서울 노원구', query: '서울 노원구' },
  { code: '11320', label: '서울 도봉구', query: '서울 도봉구' },
  { code: '11230', label: '서울 동대문구', query: '서울 동대문구' },
  { code: '11590', label: '서울 동작구', query: '서울 동작구' },
  { code: '11440', label: '서울 마포구', query: '서울 마포구' },
  { code: '11410', label: '서울 서대문구', query: '서울 서대문구' },
  { code: '11650', label: '서울 서초구', query: '서울 서초구' },
  { code: '11200', label: '서울 성동구', query: '서울 성동구' },
  { code: '11290', label: '서울 성북구', query: '서울 성북구' },
  { code: '11710', label: '서울 송파구', query: '서울 송파구' },
  { code: '11470', label: '서울 양천구', query: '서울 양천구' },
  { code: '11560', label: '서울 영등포구', query: '서울 영등포구' },
  { code: '11170', label: '서울 용산구', query: '서울 용산구' },
  { code: '11380', label: '서울 은평구', query: '서울 은평구' },
  { code: '11110', label: '서울 종로구', query: '서울 종로구' },
  { code: '11140', label: '서울 중구', query: '서울 중구' },
  { code: '11260', label: '서울 중랑구', query: '서울 중랑구' },
  { code: '41281', label: '고양 덕양구', query: '경기 고양시 덕양구' },
  { code: '41285', label: '고양 일산동구', query: '경기 고양시 일산동구' },
  { code: '41287', label: '고양 일산서구', query: '경기 고양시 일산서구' },
  { code: '41290', label: '과천시', query: '경기 과천시' },
  { code: '41210', label: '광명시', query: '경기 광명시' },
  { code: '41610', label: '광주시', query: '경기 광주시' },
  { code: '41310', label: '구리시', query: '경기 구리시' },
  { code: '41410', label: '군포시', query: '경기 군포시' },
  { code: '41570', label: '김포시', query: '경기 김포시' },
  { code: '41360', label: '남양주시', query: '경기 남양주시' },
  { code: '41190', label: '부천시', query: '경기 부천시' },
  { code: '41131', label: '성남 수정구', query: '경기 성남시 수정구' },
  { code: '41133', label: '성남 중원구', query: '경기 성남시 중원구' },
  { code: '41135', label: '성남 분당구', query: '경기 성남시 분당구' },
  { code: '41111', label: '수원 장안구', query: '경기 수원시 장안구' },
  { code: '41113', label: '수원 권선구', query: '경기 수원시 권선구' },
  { code: '41115', label: '수원 팔달구', query: '경기 수원시 팔달구' },
  { code: '41117', label: '수원 영통구', query: '경기 수원시 영통구' },
  { code: '41390', label: '시흥시', query: '경기 시흥시' },
  { code: '41271', label: '안산 상록구', query: '경기 안산시 상록구' },
  { code: '41273', label: '안산 단원구', query: '경기 안산시 단원구' },
  { code: '41550', label: '안성시', query: '경기 안성시' },
  { code: '41171', label: '안양 만안구', query: '경기 안양시 만안구' },
  { code: '41173', label: '안양 동안구', query: '경기 안양시 동안구' },
  { code: '41630', label: '양주시', query: '경기 양주시' },
  { code: '41830', label: '양평군', query: '경기 양평군' },
  { code: '41670', label: '여주시', query: '경기 여주시' },
  { code: '41463', label: '용인 기흥구', query: '경기 용인시 기흥구' },
  { code: '41465', label: '용인 수지구', query: '경기 용인시 수지구' },
  { code: '41461', label: '용인 처인구', query: '경기 용인시 처인구' },
  { code: '41430', label: '의왕시', query: '경기 의왕시' },
  { code: '41150', label: '의정부시', query: '경기 의정부시' },
  { code: '41500', label: '이천시', query: '경기 이천시' },
  { code: '41480', label: '파주시', query: '경기 파주시' },
  { code: '41220', label: '평택시', query: '경기 평택시' },
  { code: '41650', label: '포천시', query: '경기 포천시' },
  { code: '41450', label: '하남시', query: '경기 하남시' },
  { code: '41590', label: '화성시', query: '경기 화성시' },
  { code: '28185', label: '인천 연수구', query: '인천 연수구' },
  { code: '28245', label: '인천 계양구', query: '인천 계양구' },
  { code: '28260', label: '인천 서구', query: '인천 서구' },
  { code: '28200', label: '인천 남동구', query: '인천 남동구' },
  { code: '26110', label: '부산 중구', query: '부산 중구' },
  { code: '26350', label: '부산 해운대구', query: '부산 해운대구' },
  { code: '26470', label: '부산 연제구', query: '부산 연제구' },
  { code: '26500', label: '부산 수영구', query: '부산 수영구' },
  { code: '27140', label: '대구 동구', query: '대구 동구' },
  { code: '27260', label: '대구 수성구', query: '대구 수성구' },
  { code: '30170', label: '대전 서구', query: '대전 서구' },
  { code: '30200', label: '대전 유성구', query: '대전 유성구' },
  { code: '31140', label: '울산 남구', query: '울산 남구' },
  { code: '36110', label: '세종시', query: '세종특별자치시' },
];
